...
function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-white dark:bg-black flex">
      <div style={{alignSelf:'center',justifySelf:'center'}} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
            ...
            <Link to='login' className="px-8 py-4 border border-gray-300 dark:border-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 font-semibold rounded-lg transition-colors duration-200">
              Log In
            </Link>
          </div>
        </div>
